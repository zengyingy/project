...
int sockets::createNonblockingOrDie()
{
	...
	int sockfd = ::socket(AF_INET6, SOCK_STREAM | SOCK_NONBLOCK | SOCK_CLOEXEC, IPPROTO_TCP);
	if (sockfd < 0)
	{
		LOG_SYSFATAL << "sockets::createNonblockingOrDie";
	}
...
void sockets::bindOrDie(int sockfd, const struct sockaddr_in6& addr)
{
...
int sockets::connect(int sockfd, const struct sockaddr_in6& addr)
{
